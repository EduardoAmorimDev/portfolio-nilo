...
export default function Home() {
  return (
    <div className="m-auto mb-6 max-w-[1392px]">
      <header
        className="relative m-auto flex max-w-[1392px] items-center justify-between px-6 py-[18px] md:py-[38px]"
        id="topo"
      >
        <Logo />
        <MenuSquare />
      ...
      <main className="px-6 py-3">
        ...
        <section className="gap-5 py-5 md:grid md:grid-cols-3" id="contatos">
